...
document.querySelectorAll('.header-content h1').forEach(e => {
	...
	e.querySelectorAll('.letter').forEach(function(l, i) { //этот кусок кода нужен чтобы чтобы каждая следующая буква была под предыдущей
		l.setAttribute('style', `z-index: -${ i }; transition-duration: ${ i/5 + 1 }s`)
	})
})

//при свайпе страницы присваивается класс active
